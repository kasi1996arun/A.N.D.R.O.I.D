...
public class ForecastFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.weathertask,menu);
    }
    ...
    public  class weatherTask extends AsyncTask<String,Void,String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            String units="metric";
            int days=7;
            String api="0e4772ebfe5e450542d1849a2c27125c";
            try {
                // Construct the URL for the OpenWeatherMap query
                // Possible parameters are avaiable at OWM's forecast API page, at
                // http://openweathermap.org/API#forecast
                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=94043&mode=json&units=metric&cnt=7");
                //final String baseUrl = "http://api.openweathermap.org/data/2.5/forecast/daily?q=Madurai,in&mode=xml&units=metric&cnt=7&appid=0e4772ebfe5e450542d1849a2c27125c";
